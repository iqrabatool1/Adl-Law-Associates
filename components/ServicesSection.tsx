  ...
  const services = [
    {
      ...
      description:
        "Criminal defense representation in Islamabad for bail matters, trial advocacy, and High Court appeals. We protect our clients' constitutional rights at every stage of a criminal case.",
    ...
    },
    {
      ...
      description:
        'Civil litigation services covering property disputes, contract breaches, and revenue law matters, with a focus on securing fair recovery and resolution for clients.',
    ...
    },
    {
      ...
      description:
        'Family law representation for divorce, child custody, inheritance, and succession matters, handled with discretion and a focus on protecting long-term family interests.',
    ...
    },
    {
      ...
      description:
        'Corporate legal advisory for businesses, covering regulatory compliance, mergers and acquisitions, entity formation, and risk management.',
      ...
      <div className="container mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <h2 className="text-4xl md:text-6xl font-extrabold text-black mb-6 leading-tight"
            ...
            Legal Services in Islamabad by <span style={{ color: '#c5a059' }}>ADL Law Associates</span>
          </h2>

          <div className="w-24 h-1 bg-[#c5a059] mx-auto mb-8"></div>

          <p className="text-lg text-gray-600 leading-relaxed">
            Advocate Riffat Jan and the ADL Law Associates team provide legal representation
            in criminal, civil, family, and corporate law across Islamabad and Pakistan.
          </p>
        </div>
        ...
        <div className="mt-24 border-t border-gray-100 pt-16 flex flex-col items-center">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-black mb-4">Need a Lawyer in Islamabad?</h2>
